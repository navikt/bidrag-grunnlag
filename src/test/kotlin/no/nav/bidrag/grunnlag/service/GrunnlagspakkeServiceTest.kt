...
class GrunnlagspakkeServiceTest {
    ...
    fun `Test på å hente grunnlagspakke med pdl-data`() {
        ...
        // Legger først inn inn barn med to perioder som husstandsmedlem
        ...
        assertAll(
            Executable { assertThat(grunnlagspakkeFunnet).isNotNull },
            Executable { assertThat(grunnlagspakkeFunnet.grunnlagspakkeId).isEqualTo(grunnlagspakkeIdOpprettet) },
            Executable { assertThat(grunnlagspakkeFunnet.egneBarnIHusstandenListe.size).isEqualTo(2) },
            Executable { assertThat(grunnlagspakkeFunnet.egneBarnIHusstandenListe[0].partPersonId).isEqualTo("12345678901") },
            Executable { assertThat(grunnlagspakkeFunnet.egneBarnIHusstandenListe[0].relatertPersonPersonId).isEqualTo("22233344455") },
            Executable { assertThat(grunnlagspakkeFunnet.egneBarnIHusstandenListe[0].navn).isEqualTo("Svett Elefant") },
            Executable { assertThat(grunnlagspakkeFunnet.egneBarnIHusstandenListe[0].fodselsdato).isEqualTo(LocalDate.parse("2017-05-17")) },
            Executable { assertThat(grunnlagspakkeFunnet.egneBarnIHusstandenListe[0].erBarnAvBmBp).isTrue() },
            Executable { assertThat(grunnlagspakkeFunnet.egneBarnIHusstandenListe[0].hentetTidspunkt).isNotNull() },
            Executable { assertThat(grunnlagspakkeFunnet.egneBarnIHusstandenListe[0].aktiv).isTrue() },
            Executable { assertThat(grunnlagspakkeFunnet.egneBarnIHusstandenListe[0].borISammeHusstandDtoListe[0].periodeFra).isEqualTo(LocalDate.parse("2010-05-01")) },
            Executable { assertThat(grunnlagspakkeFunnet.egneBarnIHusstandenListe[0].borISammeHusstandDtoListe[0].periodeTil).isEqualTo(LocalDate.parse("2020-06-01")) },
            Executable { assertThat(grunnlagspakkeFunnet.egneBarnIHusstandenListe[0].borISammeHusstandDtoListe[1].periodeFra).isEqualTo(LocalDate.parse("2021-05-01")) },
            Executable { assertThat(grunnlagspakkeFunnet.egneBarnIHusstandenListe[0].borISammeHusstandDtoListe[1].periodeTil).isNull() },

            Executable { assertThat(grunnlagspakkeFunnet.egneBarnIHusstandenListe[1].relatertPersonPersonId).isEqualTo("98798798765") },
            Executable { assertThat(grunnlagspakkeFunnet.egneBarnIHusstandenListe[1].navn).isEqualTo("Trang Poncho") },
            Executable { assertThat(grunnlagspakkeFunnet.egneBarnIHusstandenListe[1].fodselsdato).isEqualTo(LocalDate.parse("2000-12-02")) },
            Executable { assertThat(grunnlagspakkeFunnet.egneBarnIHusstandenListe[1].erBarnAvBmBp).isTrue() },
            Executable { assertThat(grunnlagspakkeFunnet.egneBarnIHusstandenListe[1].hentetTidspunkt).isNotNull() },
            Executable { assertThat(grunnlagspakkeFunnet.egneBarnIHusstandenListe[1].borISammeHusstandDtoListe).isEmpty() },

            Executable { assertThat(grunnlagspakkeFunnet.husstandmedlemListe.size).isEqualTo(3) },
            Executable { assertThat(grunnlagspakkeFunnet.husstandmedlemListe[0].partPersonId).isEqualTo("12345678901") },
            Executable { assertThat(grunnlagspakkeFunnet.husstandmedlemListe[0].relatertPersonPersonId).isEqualTo("22233344455") },
            Executable { assertThat(grunnlagspakkeFunnet.husstandmedlemListe[0].navn).isEqualTo("Svett Elefant") },
            Executable { assertThat(grunnlagspakkeFunnet.husstandmedlemListe[0].fodselsdato).isEqualTo(LocalDate.parse("2017-05-17")) },
            Executable { assertThat(grunnlagspakkeFunnet.husstandmedlemListe[0].erBarnAvBmBp).isTrue() },
            Executable { assertThat(grunnlagspakkeFunnet.husstandmedlemListe[0].hentetTidspunkt).isNotNull() },
            Executable { assertThat(grunnlagspakkeFunnet.husstandmedlemListe[0].aktiv).isTrue() },
            Executable { assertThat(grunnlagspakkeFunnet.husstandmedlemListe[0].borISammeHusstandDtoListe[0].periodeFra).isEqualTo(LocalDate.parse("2010-05-01")) },
            Executable { assertThat(grunnlagspakkeFunnet.husstandmedlemListe[0].borISammeHusstandDtoListe[0].periodeTil).isEqualTo(LocalDate.parse("2020-06-01")) },
            Executable { assertThat(grunnlagspakkeFunnet.husstandmedlemListe[0].borISammeHusstandDtoListe[1].periodeFra).isEqualTo(LocalDate.parse("2021-05-01")) },
            Executable { assertThat(grunnlagspakkeFunnet.husstandmedlemListe[0].borISammeHusstandDtoListe[1].periodeTil).isNull() },

            Executable { assertThat(grunnlagspakkeFunnet.husstandmedlemListe[1].partPersonId).isEqualTo("12345678901") },
            Executable { assertThat(grunnlagspakkeFunnet.husstandmedlemListe[1].relatertPersonPersonId).isEqualTo("98798798765") },
            Executable { assertThat(grunnlagspakkeFunnet.husstandmedlemListe[1].navn).isEqualTo("Trang Poncho") },
            Executable { assertThat(grunnlagspakkeFunnet.husstandmedlemListe[1].fodselsdato).isEqualTo(LocalDate.parse("2000-12-02")) },
            Executable { assertThat(grunnlagspakkeFunnet.husstandmedlemListe[1].erBarnAvBmBp).isTrue() },
            Executable { assertThat(grunnlagspakkeFunnet.husstandmedlemListe[1].hentetTidspunkt).isNotNull() },
            Executable { assertThat(grunnlagspakkeFunnet.husstandmedlemListe[1].aktiv).isTrue() },
            Executable { assertThat(grunnlagspakkeFunnet.husstandmedlemListe[1].borISammeHusstandDtoListe).isEmpty() },

            Executable { assertThat(grunnlagspakkeFunnet.husstandmedlemListe[2].partPersonId).isEqualTo("12345678901") },
            Executable { assertThat(grunnlagspakkeFunnet.husstandmedlemListe[2].relatertPersonPersonId).isEqualTo("99988877766") },
            Executable { assertThat(grunnlagspakkeFunnet.husstandmedlemListe[2].navn).isEqualTo("Klam Trøffel") },
            Executable { assertThat(grunnlagspakkeFunnet.husstandmedlemListe[2].fodselsdato).isEqualTo(LocalDate.parse("1997-02-12")) },
            Executable { assertThat(grunnlagspakkeFunnet.husstandmedlemListe[2].erBarnAvBmBp).isFalse() },
            Executable { assertThat(grunnlagspakkeFunnet.husstandmedlemListe[2].hentetTidspunkt).isNotNull() },
            Executable { assertThat(grunnlagspakkeFunnet.husstandmedlemListe[2].aktiv).isTrue() },
            Executable { assertThat(grunnlagspakkeFunnet.husstandmedlemListe[2].borISammeHusstandDtoListe[0].periodeFra).isNull() },
            Executable { assertThat(grunnlagspakkeFunnet.husstandmedlemListe[2].borISammeHusstandDtoListe[0].periodeTil).isEqualTo(LocalDate.parse("2020-09-01")) },
